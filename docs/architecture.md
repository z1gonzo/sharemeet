...
| `frontend/` | UI użytkownika | Vite + React + TypeScript; Focus Dark shell z podłączonym auth/global feed/composer i mockowanym My posts/following/profile/follow/comments; design w `docs/frontend-design.md` |
