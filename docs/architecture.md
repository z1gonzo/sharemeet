...
| `frontend/` | UI użytkownika | Vite + React + TypeScript; Focus Dark shell/feed/profile/auth screens na mockowanych danych; design w `docs/frontend-design.md` |
