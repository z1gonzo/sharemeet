...
| `frontend/` | UI użytkownika | Vite + React + TypeScript; pierwszy Focus Dark shell/feed/profile na mockowanych danych; design w `docs/frontend-design.md` |
