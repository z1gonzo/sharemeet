...
| `frontend/` | UI użytkownika | Vite + React + TypeScript; Focus Dark shell z podłączonym auth/global feed i mockowanym composer/profile/follow/comments; design w `docs/frontend-design.md` |
