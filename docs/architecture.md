...
|---|---|---|
| `backend/` | API, auth, users, posts, logika biznesowa | NestJS + Prisma 6 + auth + profile + text posts CRUD + global feed foundation |
