...
| `frontend/` | UI użytkownika | Vite + React + TypeScript; Focus Dark shell z podłączonym auth i mockowanym feed/profile; design w `docs/frontend-design.md` |
