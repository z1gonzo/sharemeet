...
| `frontend/` | UI użytkownika | Vite + React + TypeScript; Focus Dark shell z podłączonym auth/global feed/following feed/composer/My posts/comments/profile/follow/profile posts preview; design w `docs/frontend-design.md` |
