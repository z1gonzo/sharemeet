...
|---|---|---|
| `backend/` | API, auth, users, posts, follows, logika biznesowa | NestJS + Prisma 6 + auth + profile + text posts CRUD + global/following feeds + follow relationships |
