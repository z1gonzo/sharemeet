...
- Frontend: Vite + React + TypeScript; Focus Dark shell with connected auth/global feed/composer and mocked profile/follow/comments (`docs/frontend-design.md`)
