...
- Frontend: Vite + React + TypeScript; Focus Dark shell with connected auth/global feed/composer/My posts and mocked following/profile/follow/comments (`docs/frontend-design.md`)
