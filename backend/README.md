...
- `UsersModule` currently provides public `GET /users/:username`, public `GET /users/:username/posts` and protected `PATCH /users/me`.
...
1. Add a minimal global feed `GET /posts` or pagination for `GET /users/:username/posts`.
